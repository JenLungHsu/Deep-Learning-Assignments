...
# from ViT import DoubleViT, ViT
from RRDB import RRDBClassifier
...
def main():
	...
	optimizer = optim.Adam(model.parameters(), lr=0.01, betas=(0.9, 0.999), eps=1e-08) # lr可調大 如果都很差得話
...
if __name__ == '__main__':
	...
	parse.add_argument('--name', '-n', type=str, default='AdvancedTwoLayerCNN_Atte')
	parse.add_argument('--epoches', '-e', type=int, default='10')
	parse.add_argument('--image_size', type=int, default='256')
	parse.add_argument('--model_name', '-mn', type=str, default='AdvancedTwoLayerCNN_Atte.pkl')
	parse.add_argument('--continue_train', type=bool, default=False)
	parse.add_argument('--model_path', '-mp', type=str, default='')
	parse.add_argument('--workers', type=int, default='8')
	parse.add_argument('--model', type=str, default='AdvancedTwoLayerCNN_Atte()') # models.resnet34(pretrained=False)
	parse.add_argument('--result_file', type=str, default='AdvancedTwoLayerCNN_Atte.txt')
